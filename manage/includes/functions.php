...
function structureInCombobox($database_link, $parent_id, $section_language, $level = 0, $current_id = 0, $black_list = '') {
...
// Types in Combobox
function typesInCombobox($database_link, $current_type = 0) {
