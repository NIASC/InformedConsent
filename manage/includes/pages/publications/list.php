<div class="row-fluid panel-title">
	...
	<div class="span6">
		<h4><?php echo $TRANSLATION['current_publications']; ?></h4>
	</div>
	...
	<div class="span6 text-right">
		<form name="add_new" method="get" action="">
			...
			<?php echo $TRANSLATION['page']; ?> - <select name="section_id">
				<?php
			...
			&nbsp; &nbsp; &nbsp;
			<input type="submit" name="doAddInfo" value="+ <?php echo $TRANSLATION['new_publication']; ?>" class="btn btn-info" />
		</form>
	</div>
...
<table class="table table-striped table-bordered">
	...
	$get_pages_query = "SELECT
						...
						WHERE
							`bc_sections`.`type` = ".(int)$section_type." AND
