...
$update_sort1_query = "UPDATE `bc_video_gal_group` SET `sort` = " . $get_sort_data->sort . " WHERE `pk` = " . $get_section_data->pk;

DBM::query($update_sort1_query);

//

$update_sort2_query = "UPDATE `bc_video_gal_group` SET `sort` = " . $get_section_data->sort . " WHERE `pk` = " . $get_sort_data->pk;
