...
<div class="row-fluid panel-container">
	...
	<div class="span12">
		...
		<h3><?php echo $TRANSLATION['list']; ?></h3>
...
if ($current_act = extractGet('act')) {
	...
	switch ($current_act) {
	    ...
	    case 'delete':
	        ...
	        break;
		case 'list':
	        require_once(DIR_PATH . 'includes/pages/listpages/list.php');
	        break;
		case 'sort':
	        require_once(DIR_PATH . 'includes/pages/listpages/sort.php');
	        break;
	    default:
	        require_once(DIR_PATH . 'includes/pages/listpages/group_list.php');
	}
