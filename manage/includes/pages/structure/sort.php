...
$update_sort1_query = "UPDATE `bc_sections` SET `sort` = " . $get_sort_data->sort . " WHERE `id` = " . $get_section_data->id;
...
$update_sort2_query = "UPDATE `bc_sections` SET `sort` = " . $get_section_data->sort . " WHERE `id` = " . $get_sort_data->id;
