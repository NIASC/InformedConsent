...
if ($get_info_result = DBM::queryData($get_info_query, $database_link)) {
	...
	$info[] = array('section' => $get_info_data, 
					'content' => info_by_id ($siteData['language'], $get_info_data->id, $count = 0, $sort_by = " `bc_info`.`sort` DESC "));
...
$smarty->assign('page_class', 'speakers');
$smarty->assign('content_file', 'submenu_page_content.tpl');
