<?php 
 $language = array(
			...
			'consent' => 'Consent',
			'participate_text' => 'I have read and understood the above information',
			'accept_text' => 'I accept that my data is used for the research project receipts data and health, where the purpose is to identify purchasing patterns associated to food borne diseases causing bad stomach and inflammatory diseases',
			...
			'phone_doesnt_match' => 'Phone doesn\'t match phone again!',
			'email_doesnt_match1' => 'email doesn\'t match!',
			...
			'repeat_email' => 'Please repeat your email',
			'repeat_phone' => 'Please repeat your phone number',
			'submit' => 'Submit',
			'storbox_account_id' => 'Storebox/ COOP account ID',
