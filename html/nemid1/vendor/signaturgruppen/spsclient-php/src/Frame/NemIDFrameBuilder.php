...
class NemIDFrameBuilder
{
    ...
    public function __construct()
    {
        ...
        if(NemIDConfig::$RememberUserId){
            $this->config->RememberUserIdToken = "";
            if(isset($_COOKIE["spsclientrememberuserid"])) {
                if(strlen($_COOKIE["spsclientrememberuserid"]) > 5) {
                    $this->config->RememberUserIdToken = $_COOKIE["spsclientrememberuserid"];
                }
            }
        }
    }
