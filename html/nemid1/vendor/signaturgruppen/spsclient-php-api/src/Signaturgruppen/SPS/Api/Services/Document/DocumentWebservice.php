...
namespace Signaturgruppen\SPS\Api\Services\Document {
    ...
    abstract class DocumentWebservice implements Webservice
    {
        ...
        /**
         * @param DocumentPadesRequest $request
         * @return DocumentPadesResponse
         */
        public abstract function createPdfAdvancedElectronicSignature(DocumentPadesRequest $request);
