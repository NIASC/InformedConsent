<?php /* Smarty version Smarty-3.1.13, created on 2016-07-20 18:34:05
         compiled from "C:\xampp\htdocs\moe.gov.ge\html\themes\default\templates\skeleton_main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:917857456106e060b5-56606235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64a378f77cfae328759c85000ba4320cb459ea17' => 
    array (
      0 => 'C:\\xampp\\htdocs\\moe.gov.ge\\html\\themes\\default\\templates\\skeleton_main.tpl',
      1 => 1469023275,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '917857456106e060b5-56606235',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_574561071d67d5_42094772',
  'variables' => 
  array (
    'site_url' => 0,
    'og_array' => 0,
...
<?php if ($_valid && !is_callable('content_574561071d67d5_42094772')) {function content_574561071d67d5_42094772($_smarty_tpl) {?><!DOCTYPE html>
...
<!-- scrolls social -->
<link rel="stylesheet" href="scripts/css/contact-buttons.css">
...
<script type="text/javascript" src="scripts/js/plugins-scroll.js"></script>
...
">
<script src="scripts/js/jquery.contact-buttons.js"></script>
	...
	<div id="container">
		...
		<header class="clearfix">
			...
			<div class="navbar navbar-default navbar-fixed-top">
				...
				<div class="top-line">
					<a href="#" class="top-line-toggle hidden"><i class="fa fa-angle-double-down" aria-hidden="true"></i></a>
					<div class="container">
...
">
							...
							<img src="themes/default/images/logo-<?php echo $_smarty_tpl->tpl_vars['site_data']->value['language'];?>
.png" alt="<?php if ($_smarty_tpl->tpl_vars['og_array']->value['title']){?><?php echo $_smarty_tpl->tpl_vars['og_array']->value['title'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['language']->value['website_title'];?>
<?php }?>"/>
...
"/> 
		...
		<div class="deer"><a href="#"><img class="deer" src="themes/default/images/<?php echo $_smarty_tpl->tpl_vars['slider_decor']->value;?>
...
?>
            <div class="item news-item">
            	<div class="inner-item">
                	<img alt="<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['banner']->value['title']);?>
" src="res/images/<?php echo $_smarty_tpl->tpl_vars['banner']->value['file'];?>
"/>
                    <div class="hover-item">
                    	<ul>
                        	<li><a class="autor" ><i class="fa fa-user"></i><?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['banner']->value['title']);?>
</a></li>
                            <li><a class="date" href="<?php echo $_smarty_tpl->tpl_vars['banner']->value['url'];?>
" target="<?php echo $_smarty_tpl->tpl_vars['banner']->value['target'];?>
"><i class="fa fa-link"></i><?php echo $_smarty_tpl->tpl_vars['banner']->value['url'];?>
</a></li>
						</ul>
					</div>
				</div>
...
"><img src="themes/default/images/fb.png" /></a><?php }?>
...
"><img src="themes/default/images/youtube.png" /></a><?php }?>
...
"><img src="themes/default/images/twitter.png" /></a><?php }?>
...
"><img src="themes/default/images/flickr.png" /></a><?php }?>
	...
	<div id="test-popup" class="white-popup mfp-hide">
		<div class='lightbox-content'>
			<h2><?php echo $_smarty_tpl->tpl_vars['language']->value['hotline'];?>
</h2>
			<form method="post" id="hotline" action="<?php echo $_smarty_tpl->tpl_vars['site_url']->value;?>
<?php echo $_smarty_tpl->tpl_vars['site_data']->value['language'];?>
/<?php echo $_smarty_tpl->tpl_vars['contact_slug']->value;?>
" class="contact-form">
				<div class="text-input">
					<div class="float-input">
						<input name="name" id="name" type="text" placeholder="<?php echo $_smarty_tpl->tpl_vars['language']->value['name'];?>
"/>
						<span><i class="fa fa-user"></i></span>
					</div>
					
					<div class="float-input">
						<input name="email" id="email" type="text" placeholder="<?php echo $_smarty_tpl->tpl_vars['language']->value['email'];?>
"/>
						<span><i class="fa fa-envelope"></i></span>
					</div>
					
					<div class="float-input">
						<input name="phone" id="phone" type="text" placeholder="<?php echo $_smarty_tpl->tpl_vars['language']->value['phone'];?>
"/>
				...
				<div class="textarea-input">
					<textarea name="message" id="message" placeholder="<?php echo $_smarty_tpl->tpl_vars['language']->value['message'];?>
"></textarea>
					<span><i class="fa fa-comment"></i></span>
				</div>
				<div class="textarea-input">
					<div class="msg2 message red hidden"><?php echo $_smarty_tpl->tpl_vars['language']->value['required_notify'];?>
</div>
				</div>
...
<script type="application/javascript">
	...
	jQuery('#hotline').submit(
		function(){
			var error = 0;
			if(jQuery('.lightbox-content #name').val() == '') error++;
			if(jQuery('.lightbox-content #email').val() == '') error++;
			if(jQuery('.lightbox-content #phone').val() == '') error++;
			if(jQuery('.lightbox-content #message').val() == '') error++;
			if(error > 0) {
				jQuery('.msg2.message').removeClass('hidden');
				return false;
			}
	});
...
jQuery('.top-line-toggle').click(
	function(){
		jQuery(this).parent('.top-line').toggleClass('active');
		
		jQuery(this).children('i').toggleClass('fa-angle-double-down fa-times');
		return false;
});
